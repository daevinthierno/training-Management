  ...
  # code...
          ...
          $empnum = mysqli_num_rows($result);
             ...
             if ($res_safety) {
              ...
              $ssnum = round(($snum * 100/$empnum));
              
              
          echo ",['".$depname."',".$ssnum.",'".$depname.", ".$snum." Employees: ".$ssnum."%']";
         }
}
...
function drawChart() {
  ...
  ['Departments', 'Safety training', {role: 'tooltip'}]
  <?php echo displayTable1($conn);?>
]);

  // Optional; add a title and set the width and height of the chart
  var options = {'title':'SAFETY TRAINING REPORT', 'width':800, 'height':500,
                  width: 1200,
          scales: {
            xAxes: [{
