...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title text-center text-bold"><i class="fa fa-shield "></i> SAFETY TRAINING
            <input type="hidden" name="type" id="type" value="SAFETY TRAINING">
        </h3>
    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trainer">FIRST TRAINER</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trainer">SECOND TRAINER</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trainer">THIRD TRAINER</label>
                ...
                <div class="col-md-4 pull-right">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="date" id="date" placeholder="Enter the Date">
                    </div>
                </div>
            </div>
        </div>
...
<div class="box-footer">
    <div class="box">
        ...
        <div class="box-footer">
            <button type="submit" class="btn btn-primary btn-raised pull-right" name="validate" id="validate">VALIDATE
            </button>
        </div>
    </div>
</div>
